...
import { sendTelegramMessage } from "@/common/utils/actions/send-email";
    ...
    >
      ...
      <div className="w-[min(100%,38rem)] px-4">
        <p className="mb-20 mt-6 text-gray-700 dark:text-white/80">
          ...
          <a className="underline" href="mailto:abdullohaziz559@gmail.com">
          abdullohaziz559@gmail.com
          </a>{" "}
        ...
        <form
          ...
          action={async (formData) => {
            const { error } = await sendTelegramMessage(formData);

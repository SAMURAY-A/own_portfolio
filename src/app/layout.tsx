...
export const metadata: Metadata = {
  title: 'Abdullohaziz  | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Abdullohaziz Jumanazarov! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
